...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        services.setBounds(100,410,210,30);
        add(services);
        
        c1 = new JCheckBox(" ATM CARD");
        c1.setBackground(Color.WHITE);
        c1.setFont(new Font("Raleway", Font.BOLD, 16));
        c1.setBounds(100, 450, 190, 20);
        add(c1);
        
        c2 = new JCheckBox(" Internet Banking");
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway", Font.BOLD, 16));
        c2.setBounds(350, 450, 190, 20);
        add(c2);
        
        c3 = new JCheckBox(" Mobile Banking");
        c3.setBackground(Color.WHITE);
        c3.setFont(new Font("Raleway", Font.BOLD, 16));
        c3.setBounds(100, 485, 190, 20);
        add(c3);
        
        c4 = new JCheckBox(" E-mail & SMS Alerts");
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raleway", Font.BOLD, 16));
        c4.setBounds(350, 485, 190, 20);
        add(c4);
        
        c5 = new JCheckBox(" Cheque Book");
        c5.setBackground(Color.WHITE);
        c5.setFont(new Font("Raleway", Font.BOLD, 16));
        c5.setBounds(100, 520, 190, 20);
        add(c5);
        
        c6 = new JCheckBox(" E-Statement");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("Raleway", Font.BOLD, 16));
        c6.setBounds(350, 520, 190, 20);
        add(c6);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == submit) {
            ...
            String cardnumber = " " + Math.abs((random.nextLong() % 90000000L) + 9792622000000000L);
